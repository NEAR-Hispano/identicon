...
const ValidatorsList = (props: any) => {
  const { items } = props;

  if (!items) return <Loading>Cargando la lista de validadores</Loading>;
      ...
      >
        <Flex alignItems="center">
          ...
          <Stack spacing={0} lineHeight="1.4em">
            <Text>Anónimo ({t.validator_id.split(".")[0]})</Text>
            <Text fontSize="sm">
