    ...
    >
      ...
      >
        <Action>
          ...
          >
            <Text fontSize={{ base: "lg", lg: "md" }} textAlign="start" px={12}>
              Si deseas registrarte para solicitar la fé de vida tuya o de tus
        ...
        <Action>
          ...
          >
            <Text fontSize={{ base: "lg", lg: "md" }} textAlign="start" px={12}>
              Si eres un desarrollador y deseas solicitar verificaciones desde
              tu App
            </Text>
            <Box w="80%" pt={7}>
              <Button
