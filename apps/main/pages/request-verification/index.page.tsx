...
const RequestVerification = (props: Props) => {
  ...
  const form = useFormik({
    ...
    onSubmit: async (values: RequestVerificationData) => {
      console.log("calling request verification", {
  ...
  return (
    <>
      ...
      >
        ...
        <Text fontSize="sm">
          Necesitamos que completes estos datos de la persona que será
          verificada.
          <br />
          Todos serán tratados respetando las leyes de Protección de Datos
          Personales.
          <br />
          <b>
            La verificación puede producirse dentro de las próximas 48 hs según
            disponibilidad.
          </b>
        </Text>
      </Alert>
      ...
      >
        <Flex alignItems="flex-start">
          ...
          >
            <FormControl
              isInvalid={!!form.errors.requestFor && !!form.touched.requestFor}
            >
              <FormLabel>
              ...
              <RadioGroup
                ...
                onChange={(e) => form.setFieldValue("requestFor", e)}
              >
            ...
            >
              ...
              <RadioGroup
                ...
                onBlur={form.handleBlur}
                onChange={(e) => form.setFieldValue("verificationType", e)}
              >
                <Stack spacing={4} direction="column">
                  <Radio value="remote">Remota, por WhatsApp o Telegram</Radio>
                  <Radio value="onSite">
                    Presencial, con visita al domicilio
                  </Radio>
                </Stack>
              </RadioGroup>
              <FormErrorMessage>
            ...
            <FormControl
              isInvalid={!!form.touched.region && !!form.errors.region}
            >
            ...
            <FormControl
              isInvalid={!!form.touched.comune && !!form.errors.comune}
            >
            ...
            <FormControl isInvalid={!!form.touched.dni && !!form.errors.dni}>
